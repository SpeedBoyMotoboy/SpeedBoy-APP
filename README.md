...
sozinha — **nome e endereço**, e nada além disso: a lista de paradas mostra a
observação embaixo do endereço, e despejar ali o motivo da diligência fazia
três linhas de texto jurídico aparecerem coladas no endereço de cada parada.
A mesma aba traz o contador do **contrato fixo** (um valor fechado por um
pacote de demandas): quantas já foram, quantas faltam e quanto isso dá. Nasceu de um cliente que
